...
class IPhoneX1VC: NSObject {
    ...
    class func drawIPhoneX1VC(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 812), resizing: ResizingBehavior = .aspectFit) {
        ...
        /// Rectangle
        let rectangle = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 375, height: 812))
        context.saveGState()
        context.saveGState()
        ...
        /// Rectangle 2
        let rectangle2 = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 324, height: 697))
        context.saveGState()
        context.setAlpha(0.17)
        context.beginTransparencyLayer(auxiliaryInfo: nil)
        do {
            context.translateBy(x: 26, y: 58)
            context.saveGState()
            rectangle2.addClip()
            context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                        UIColor.white.cgColor,
                        UIColor(hue: 0.177, saturation: 0.318, brightness: 0.342, alpha: 1).cgColor,
                        UIColor(white: 0.636, alpha: 1).cgColor,
                        UIColor(white: 0.494, alpha: 1).cgColor,
                        UIColor.white.cgColor,
                        UIColor.white.cgColor,
                        UIColor(white: 0.847, alpha: 1).cgColor,
                    ] as CFArray, locations: [0, 0, 0.11, 0.34, 0.84, 1, 1])!,
                start: CGPoint(x: 162, y: 0),
                end: CGPoint(x: 162, y: 697),
        ...
        /// Ваш личный помощник
        let layer = NSMutableAttributedString(string: "Ваш личный помощник\nв изучении латинского \tказахского языка")
        ...
        context.saveGState()
        layer.draw(in: CGRect(x: 43, y: 420, width: 290, height: 215))
        context.restoreGState()
        ...
        darisAlu.addAttribute(.font, value: UIFont(name: "LucidaGrande-Bold", size: 35)!, range: NSRange(location: 0, length: darisAlu.length))
        darisAlu.addAttribute(.kern, value: 0.53, range: NSRange(location: 0, length: darisAlu.length))
        darisAlu.addAttribute(.foregroundColor, value: UIColor(hue: 0.154, saturation: 0.887, brightness: 0.971, alpha: 1), range: NSRange(location: 0, length: darisAlu.length))
        context.saveGState()
        darisAlu.draw(at: CGPoint(x: 43, y: 288))
        context.restoreGState()
        
        /// Добро пожаловать
        let layer2 = NSMutableAttributedString(string: "Добро пожаловать")
        layer2.addAttribute(.font, value: UIFont(name: "LucidaGrande", size: 30)!, range: NSRange(location: 0, length: layer2.length))
        layer2.addAttribute(.kern, value: 0.64, range: NSRange(location: 0, length: layer2.length))
        do {
        ...
        context.saveGState()
        layer2.draw(at: CGPoint(x: 43, y: 135))
        context.restoreGState()
    ...
    class func imageOfIPhoneX1VC() -> UIImage {
        struct LocalCache {
    ...
    class func imageOfIPhoneXBarsTabBar3Items() -> UIImage {
        ...
        IPhoneX1VC.drawIPhoneXBarsTabBar3Items()
        image = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    class func imageOfLeaderboardRect() -> UIImage {
        ...
        IPhoneX1VC.drawLeaderboardRect()
        image = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    class func imageOfCategoryBlockConcr() -> UIImage {
        ...
        IPhoneX1VC.drawCategoryBlockConcr()
        image = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
